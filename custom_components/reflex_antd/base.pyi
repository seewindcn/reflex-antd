"""Stub file for custom_components/reflex_antd/base.py"""
# ------------------- DO NOT EDIT ----------------------
...
from reflex.constants import Reflex, MemoizationDisposition, MemoizationMode
...
memo_never_no_recursive = MemoizationMode().set(
    disposition=MemoizationDisposition.NEVER, recursive=False
)
memo_always = MemoizationMode().set(disposition=MemoizationDisposition.ALWAYS)
memo_always_no_recursive = MemoizationMode().set(
...
class ExVar(BaseVar):
    @classmethod
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        cls,
        value: Any,
...
class ContainVar(ExVar):
    @classmethod
    def create(cls, _args_: Any = None, **kwargs) -> Self: ...  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
