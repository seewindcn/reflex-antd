"""Stub file for custom_components/reflex_antd/antd/collapse.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Collapse(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        cls,
        *children,
        accordion: Optional[Union[Var[bool], bool]] = None,
        active_key: Optional[
            Union[
                Var[Union[int, list[int], list[str], str]],
                list[str],
                str,
                list[int],
                int,
        ...
        destroy_inactive_panel: Optional[Union[Var[bool], bool]] = None,
        expand_icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        collapsible: Optional[Union[Var[str], str]] = None,
        expand_icon_position: Optional[Union[Var[str], str]] = None,
        ghost: Optional[Union[Var[bool], bool]] = None,
