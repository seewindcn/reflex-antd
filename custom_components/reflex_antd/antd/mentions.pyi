"""Stub file for custom_components/reflex_antd/antd/mentions.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Mention(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        prefix: Optional[Union[Var[Union[List[str], str]], str, List[str]]] = None,
        split: Optional[Union[Var[str], str]] = None,
        status: Optional[
            Union[
                Var[
                    Literal[
        ...
        validate_search: Optional[Union[Var[JsValue], JsValue]] = None,
        ...
        options: Optional[Union[Var[ContainVar], ContainVar]] = None,
