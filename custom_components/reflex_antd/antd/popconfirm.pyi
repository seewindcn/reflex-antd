"""Stub file for custom_components/reflex_antd/antd/popconfirm.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Popconfirm(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        cls,
        *children,
        cancel_button_orops: Optional[Union[Var[dict], dict]] = None,
        cancel_text: Optional[Union[Var[str], str]] = None,
        disabled: Optional[Union[Var[bool], bool]] = None,
        icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        ok_button_props: Optional[Union[Var[dict], dict]] = None,
        ok_text: Optional[Union[Var[str], str]] = None,
        ok_type: Optional[
            Union[
        ...
        show_cancel: Optional[Union[Var[bool], bool]] = None,
