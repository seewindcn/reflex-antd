"""Stub file for custom_components/reflex_antd/antd/qrcode.py"""
# ------------------- DO NOT EDIT ----------------------
...
class QRCode(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        type: Optional[
            Union[Var[Literal["canvas", "svg"]], Literal["canvas", "svg"]]
        ] = None,
        icon: Optional[Union[Var[str], str]] = None,
        size: Optional[Union[Var[int], int]] = None,
        icon_size: Optional[Union[Var[int], int]] = None,
        color: Optional[Union[Var[str], str]] = None,
        bg_color: Optional[Union[Var[str], str]] = None,
        bordered: Optional[Union[Var[bool], bool]] = None,
        error_level: Optional[
            Union[Var[Literal["L", "M", "Q", "H"]], Literal["L", "M", "Q", "H"]]
        ] = None,
        status: Optional[
            Union[
                Var[Literal["active", "expired", "loading", "scanned"]],
                Literal["active", "expired", "loading", "scanned"],
            ]
        ] = None,
