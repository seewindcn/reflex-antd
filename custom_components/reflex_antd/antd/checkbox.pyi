"""Stub file for custom_components/reflex_antd/antd/checkbox.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Checkbox(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        indeterminate: Optional[Union[Var[bool], bool]] = None,
...
class CheckboxGroup(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        options: Optional[
            Union[Var[List[Union[Dict, int, str]]], List[Union[Dict, int, str]]]
        ] = None,
        value: Optional[
            Union[Var[List[Union[bool, int, str]]], List[Union[bool, int, str]]]
        ] = None,
        _custom_components: Optional[Set[CustomComponent]] = None,
        _ex_hooks: Optional[List[ContainVar]] = None,
        style: Optional[Style] = None,
