"""Stub file for custom_components/reflex_antd/antd/segmented.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Segmented(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        default_value: Optional[Union[Var[Union[int, str]], int, str]] = None,
        disabled: Optional[Union[Var[bool], bool]] = None,
        options: Optional[Union[List[Dict], List[int], List[str]]] = None,
        size: Optional[
            Union[
