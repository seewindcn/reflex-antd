"""Stub file for custom_components/reflex_antd/antd/timeline.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Timeline(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        mode: Optional[
            Union[
                Var[Literal["left", "alternate", "right"]],
                Literal["left", "alternate", "right"],
            ]
        ] = None,
        pending: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        pending_dot: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
