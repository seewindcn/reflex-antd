"""Stub file for custom_components/reflex_antd/antd/float_button.py"""
# ------------------- DO NOT EDIT ----------------------
...
class FloatButton(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        shape: Optional[
            Union[Var[Literal["circle", "square"]], Literal["circle", "square"]]
        ] = None,
        href: Optional[Union[Var[str], str]] = None,
        target: Optional[Union[Var[str], str]] = None,
        badge: Optional[Union[Var[Dict], Dict]] = None,
...
class FloatGroup(FloatButton):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        close_icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        description: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        tooltip: Optional[
            Union[Var[Union[Component, JsValue, str]], str, Component, JsValue]
...
class FloatBackTop(FloatButton):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        visibility_height: Optional[Union[Var[int], int]] = None,
        icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        description: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        tooltip: Optional[
            Union[Var[Union[Component, JsValue, str]], str, Component, JsValue]
