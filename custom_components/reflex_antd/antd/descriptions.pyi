"""Stub file for custom_components/reflex_antd/antd/descriptions.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Descriptions(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        column: Optional[Union[Var[Union[dict, int]], int, dict]] = None,
        ...
        items: Optional[
            Union[Var[Union[ContainVar, JsValue, list]], JsValue, ContainVar, list]
        ] = None,
        label_style: Optional[Union[Var[dict], dict]] = None,
        layout: Optional[
            Union[
