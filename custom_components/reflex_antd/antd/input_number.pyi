"""Stub file for custom_components/reflex_antd/antd/input_number.py"""
# ------------------- DO NOT EDIT ----------------------
...
class InputNumber(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        change_on_blur: Optional[Union[Var[bool], bool]] = None,
        change_on_wheel: Optional[Union[Var[bool], bool]] = None,
        controls: Optional[
            Union[Var[Union[ContainVar, bool]], bool, ContainVar]
        ] = None,
        decimal_separator: Optional[Union[Var[str], str]] = None,
        placeholder: Optional[Union[Var[str], str]] = None,
        default_value: Optional[Union[Var[int], int]] = None,
        disabled: Optional[Union[Var[bool], bool]] = None,
        formatter: Optional[Union[Var[JsValue], JsValue]] = None,
        keyboard: Optional[Union[Var[bool], bool]] = None,
        max: Optional[Union[Var[int], int]] = None,
        min: Optional[Union[Var[int], int]] = None,
        parser: Optional[Union[Var[JsValue], JsValue]] = None,
        precision: Optional[Union[Var[int], int]] = None,
        ...
        step: Optional[Union[Var[Union[int, str]], int, str]] = None,
        string_mode: Optional[Union[Var[bool], bool]] = None,
