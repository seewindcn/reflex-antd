"""Stub file for custom_components/reflex_antd/antd/button.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Button(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        danger: Optional[Union[Var[bool], bool]] = None,
        ...
        html_type: Optional[Union[Var[str], str]] = None,
        icon: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        loading: Optional[Union[Var[bool], bool]] = None,
        shape: Optional[
            Union[
                Var[Literal["default", "circle", "round"]],
                Literal["default", "circle", "round"],
            ]
        ] = None,
        size: Optional[
            Union[
