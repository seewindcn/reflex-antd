"""Stub file for custom_components/reflex_antd/antd/radio.py"""
# ------------------- DO NOT EDIT ----------------------
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        button_style: Optional[
            Union[Var[Literal["outline", "solid"]], Literal["outline", "solid"]]
        ] = None,
        ...
        options: Optional[
            Union[
                Var[Union[ContainVar, List[Union[int, str]]]],
                List[Union[int, str]],
                ContainVar,
            ]
        ] = None,
        option_type: Optional[
            Union[Var[Literal["default", "button"]], Literal["default", "button"]]
        ] = None,
        size: Optional[
            Union[
