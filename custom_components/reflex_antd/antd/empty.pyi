"""Stub file for custom_components/reflex_antd/antd/empty.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Empty(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        image: Optional[Union[Var[Union[Component, str]], str, Component]] = None,
        image_style: Optional[Union[Var[dict], dict]] = None,
