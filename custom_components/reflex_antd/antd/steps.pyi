"""Stub file for custom_components/reflex_antd/antd/steps.py"""
# ------------------- DO NOT EDIT ----------------------
...
class Steps(AntdComponent):
    ...
    def create(  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore  # type: ignore
        ...
        *children,
        ...
        initial: Optional[Union[Var[int], int]] = None,
        label_placement: Optional[
            Union[
                Var[Literal["vertical", "horizontal", "inline"]],
                Literal["vertical", "horizontal", "inline"],
            ]
        ...
        progress_dot: Optional[Union[Var[Union[JsValue, bool]], bool, JsValue]] = None,
        ...
        status: Optional[
            Union[
                Var[Literal["wait", "process", "finish", "error"]],
                Literal["wait", "process", "finish", "error"],
            ]
        ] = None,
        type: Optional[
            Union[
                Var[Literal["default", "navigation", "inline"]],
                Literal["default", "navigation", "inline"],
            ]
        ] = None,
        items: Optional[Union[Var[ContainVar], ContainVar]] = None,
